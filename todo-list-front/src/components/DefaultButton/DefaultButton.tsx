...
export function DefaultButton(defaultButton: DefaultButtonProps) {
  return (
    <button
      ...
      className={`focus:ring-3 group mb-2 flex h-fit rounded-lg bg-gradient-to-br ${defaultButton.color == "blue" ? "from-purple-600 to-blue-500" : "from-red-400 to-red-700"} p-0.5 font-medium ${defaultButton.color == "blue" ? "focus:ring-blue-300 dark:focus:ring-blue-900" : "focus:ring-rose-400 dark:focus:ring-rose-950"} `}
    >
